...
<body>
    ...
    <!-- Form Container with Bootstrap classes -->
    <div class="container mt-5">
        <div class="card shadow-sm">
            <div class="card-body">
                <h1 class="card-title text-center mb-4">Course Details</h1>
                <form method="GET" action="add_topic_name_only.php">
                    <!-- Course Dropdown -->
                    <div class="mb-3">
                        <label for="course-dropdown" class="form-label">Select Course</label>
                        <select id="course-dropdown" name="course" class="form-select" aria-label="Select Course">
                    ...
                    <!-- Submit Button -->
                    <button type="submit" name="submit" id="submit" class="btn btn-success w-100">Add Topics</button>
                </form>
            </div>
        </div>
    </div>
